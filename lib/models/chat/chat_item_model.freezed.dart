...
mixin _$ChatItemModel {
  ...
  String get sendMsg => throw _privateConstructorUsedError;
  String get receiveMsg => throw _privateConstructorUsedError;
  MsgTypeEnum get msgType => throw _privateConstructorUsedError;
  int get sendId => throw _privateConstructorUsedError;
...
abstract class $ChatItemModelCopyWith<$Res> {
  factory $ChatItemModelCopyWith(
      ...
      _$ChatItemModelCopyWithImpl<$Res, ChatItemModel>;
  @useResult
  $Res call(
      {int? id,
      int conversationId,
...
/// @nodoc
class _$ChatItemModelCopyWithImpl<$Res, $Val extends ChatItemModel>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      sendMsg: null == sendMsg
          ? _value.sendMsg
          : sendMsg // ignore: cast_nullable_to_non_nullable
              as String,
      receiveMsg: null == receiveMsg
          ? _value.receiveMsg
          : receiveMsg // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
abstract class _$$ChatItemModelImplCopyWith<$Res>
    implements $ChatItemModelCopyWith<$Res> {
  factory _$$ChatItemModelImplCopyWith(
          _$ChatItemModelImpl value, $Res Function(_$ChatItemModelImpl) then) =
      __$$ChatItemModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$ChatItemModelImplCopyWithImpl<$Res>
    extends _$ChatItemModelCopyWithImpl<$Res, _$ChatItemModelImpl>
    implements _$$ChatItemModelImplCopyWith<$Res> {
  __$$ChatItemModelImplCopyWithImpl(
      _$ChatItemModelImpl _value, $Res Function(_$ChatItemModelImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$ChatItemModelImpl
    with DiagnosticableTreeMixin
    implements _ChatItemModel {
  const _$ChatItemModelImpl(
      {this.id,
      ...
      @JsonKey(
          ...
          fromJson: ChatResStatusEnum.fromJson,
          toJson: ChatResStatusEnum.toJson)
      this.status = ChatResStatusEnum.error,
      this.extens});

  factory _$ChatItemModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$ChatItemModelImplFromJson(json);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('sendMsg', sendMsg))
      ..add(DiagnosticsProperty('receiveMsg', receiveMsg))
      ..add(DiagnosticsProperty('msgType', msgType))
      ..add(DiagnosticsProperty('sendId', sendId))
      ..add(DiagnosticsProperty('receiveId', receiveId))
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ChatItemModelImpl &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.conversationId, conversationId) ||
                other.conversationId == conversationId) &&
            (identical(other.sendMsg, sendMsg) || other.sendMsg == sendMsg) &&
            (identical(other.receiveMsg, receiveMsg) ||
                other.receiveMsg == receiveMsg) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ChatItemModelImplCopyWith<_$ChatItemModelImpl> get copyWith =>
      __$$ChatItemModelImplCopyWithImpl<_$ChatItemModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$ChatItemModelImplToJson(
      this,
    );
  }
}
...
abstract class _ChatItemModel implements ChatItemModel {
  const factory _ChatItemModel(
      ...
      required final String sendMsg,
      required final String receiveMsg,
      required final MsgTypeEnum msgType,
      required final int sendId,
      required final int receiveId,
      final String? desc,
      ...
      @JsonKey(
          ...
          toJson: ChatResStatusEnum.toJson)
      final ChatResStatusEnum status,
      final String? extens}) = _$ChatItemModelImpl;

  factory _ChatItemModel.fromJson(Map<String, dynamic> json) =
      _$ChatItemModelImpl.fromJson;
  ...
  String get sendMsg;
  @override
  String get receiveMsg;
  @override
  MsgTypeEnum get msgType;
  @override
  int get sendId;
  @override
  int get receiveId;
