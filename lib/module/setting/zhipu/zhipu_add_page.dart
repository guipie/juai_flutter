...
class _ZhiPuAddPageState extends ConsumerState<ZhiPuAddPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ref
          .watch(zhiPuApiServerAddressProvider.notifier)
          .update((state) => openAi.apiServer ?? APIType.zhipu.host);
    });
  }
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.openAi?.time != null
              ? "${S.current.edit} ${APIType.zhipu.name} ${S.current.servers}"
              : "${S.current.btn_add} ${APIType.zhipu.name} ${S.current.servers}"),
        ),
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, _) {
                        ...
                        String server =
                            ref.watch(zhiPuApiServerAddressProvider);
                          ...
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              child: ListTile(
                                onTap: () {
                                  ref
                                      .watch(zhiPuApiServerAddressProvider
                                          .notifier)
                                      .state = list[index];
                                },
              ...
              Container(
                ...
                openAi.apiServer =
                    ref.watch(zhiPuApiServerAddressProvider.notifier).state;
              ...
              Container(
                ...
                if (widget.openAi?.time != null) {
                  result = await ref
                      .read(openAiListProvider(APIType.zhipu).notifier)
                      .update(openAi);
                } else {
                  result = await ref
                      .read(openAiListProvider(APIType.zhipu).notifier)
