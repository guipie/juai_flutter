      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.openAi?.time != null
              ? "${S.current.edit} ${APIType.kimi.name} ${S.current.servers}"
              : "${S.current.btn_add} ${APIType.kimi.name} ${S.current.servers}"),
        ),
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, _) {
                        ...
                        String server = ref.watch(kimiApiServerAddressProvider);
