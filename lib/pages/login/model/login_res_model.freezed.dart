...
$LoginResModelCopyWith<LoginResModel> get copyWith => throw _privateConstructorUsedError;
...
/// @nodoc
class _$LoginResModelCopyWithImpl<$Res,$Val extends LoginResModel> implements $LoginResModelCopyWith<$Res> {
...
/// Create a copy of LoginResModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? account = freezed,Object? nickName = freezed,Object? avatar = freezed,Object? phone = freezed,Object? email = freezed,Object? remark = freezed,Object? sex = freezed,Object? tokenNum = freezed,Object? payType = freezed,Object? userId = freezed,Object? refreshToken = freezed,Object? accessToken = freezed,}) {
...
as String?,remark: freezed == remark ? _value.remark : remark // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
abstract class _$$LoginResModelImplCopyWith<$Res> implements $LoginResModelCopyWith<$Res> {
...
/// @nodoc
class __$$LoginResModelImplCopyWithImpl<$Res> extends _$LoginResModelCopyWithImpl<$Res, _$LoginResModelImpl> implements _$$LoginResModelImplCopyWith<$Res> {
  __$$LoginResModelImplCopyWithImpl(_$LoginResModelImpl _value, $Res Function(_$LoginResModelImpl) _then)
      : super(_value, _then);
...
class _$LoginResModelImpl  implements _LoginResModel {
  const _$LoginResModelImpl({@JsonKey(name: 'account') this.account, @JsonKey(name: 'nickName') this.nickName, @JsonKey(name: 'avatar') this.avatar, @JsonKey(name: 'phone') this.phone, @JsonKey(name: 'email') this.email, @JsonKey(name: 'remark') this.remark, @JsonKey(name: 'sex') this.sex, @JsonKey(name: 'tokenNum') this.tokenNum, @JsonKey(name: 'payType') this.payType, @JsonKey(name: 'userId') this.userId, @JsonKey(name: 'refreshToken') this.refreshToken, @JsonKey(name: 'accessToken') this.accessToken});

  factory _$LoginResModelImpl.fromJson(Map<String, dynamic> json) => _$$LoginResModelImplFromJson(json);
...
@override
String toString() {
  return 'LoginResModel(account: $account, nickName: $nickName, avatar: $avatar, phone: $phone, email: $email, remark: $remark, sex: $sex, tokenNum: $tokenNum, payType: $payType, userId: $userId, refreshToken: $refreshToken, accessToken: $accessToken)';
}
...
_$$LoginResModelImplCopyWith<_$LoginResModelImpl> get copyWith => __$$LoginResModelImplCopyWithImpl<_$LoginResModelImpl>(this, _$identity);
...
Map<String, dynamic> toJson() {
  return _$$LoginResModelImplToJson(this, );
}
}
...
_$$LoginResModelImplCopyWith<_$LoginResModelImpl> get copyWith => throw _privateConstructorUsedError;
