...
mixin _$LoginResModel {
  ...
  @JsonKey(name: 'tokenNum')
  int? get tokenNum => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      sex: freezed == sex
          ...
          : sex // ignore: cast_nullable_to_non_nullable
              as int?,
      tokenNum: freezed == tokenNum
          ? _value.tokenNum
          : tokenNum // ignore: cast_nullable_to_non_nullable
              as int?,
...
class _$LoginResModelImpl implements _LoginResModel {
  const _$LoginResModelImpl(
      ...
      @JsonKey(name: 'tokenNum') this.tokenNum,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.tokenNum, tokenNum) ||
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, account, nickName, avatar, phone,
      email, remark, sex, tokenNum, payType, userId, refreshToken, accessToken);
...
abstract class _LoginResModel implements LoginResModel {
  const factory _LoginResModel(
          ...
          @JsonKey(name: 'tokenNum') final int? tokenNum,
