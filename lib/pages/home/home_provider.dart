...
final menus = [
  MenuItem(S.current.home_chat, Icons.chat_bubble_outline, Icons.chat_bubble, 0),
  MenuItem(S.current.home_model, Icons.model_training_outlined, Icons.model_training, 1),
