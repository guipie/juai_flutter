...
import 'package:guxin_ai/pages/bbs/widgets/article_card.dart';
import 'package:guxin_ai/pages/bbs/widgets/dongtai_card.dart';

class IndexCardWidget extends StatelessWidget {
  const IndexCardWidget(this.content, {Key? key}) : super(key: key);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (content.category == BaCategory.Text || content.category == BaCategory.Image || content.category == BaCategory.Video) DongtaiCardWidget(content),
            if (content.category == BaCategory.Article) AriticleCardWidget(content),
          ],
        ),
      ),
    );
