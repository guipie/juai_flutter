...
class KimiAddPage extends ConsumerStatefulWidget {
  final AllModelBean? openAi;

  const KimiAddPage({super.key, this.openAi});

  @override
  ConsumerState createState() => _KimiAddPageState();
}

class _KimiAddPageState extends ConsumerState<KimiAddPage> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.openAi?.time != null ? '${S.current.edit} ${APIType.kimi.name} ${S.current.servers}' : '${S.current.btn_add} ${APIType.kimi.name} ${S.current.servers}'),
        ),
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, _) {
                        var list = [APIType.kimi.host];
                        var server = ref.watch(kimiApiServerAddressProvider);
              ...
              Container(
                ...
                if (ref.watch(kimiApiServerAddressProvider).isEmpty) {
