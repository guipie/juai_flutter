...
class CohereAddPage extends ConsumerStatefulWidget {
  final AllModelBean? openAi;

  const CohereAddPage({super.key, this.openAi});

  @override
  ConsumerState createState() => _CohereAddPageState();
}

class _CohereAddPageState extends ConsumerState<CohereAddPage> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.openAi?.time != null ? '${S.current.edit} ${APIType.coHere.name} ${S.current.servers}' : '${S.current.btn_add} ${APIType.coHere.name} ${S.current.servers}'),
        ),
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, _) {
                        ...
                        var server = ref.watch(cohereApiServerAddressProvider);
              ...
              Container(
                ...
                if (ref.watch(cohereApiServerAddressProvider).isEmpty) {
