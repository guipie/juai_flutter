...
class _DeepSeekAddPageState extends ConsumerState<DeepSeekAddPage> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.openAi?.time != null ? '${S.current.edit} ${APIType.deepSeek.name} ${S.current.servers}' : '${S.current.btn_add} ${APIType.deepSeek.name} ${S.current.servers}'),
        ),
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, _) {
                        ...
                        var server = ref.watch(deepSeekApiServerAddressProvider);
