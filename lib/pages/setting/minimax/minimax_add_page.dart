...
class _MiniMaxAddPageState extends ConsumerState<MiniMaxAddPage> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.openAi?.time != null ? '${S.current.edit} ${APIType.miniMax.name} ${S.current.servers}' : '${S.current.btn_add} ${APIType.miniMax.name} ${S.current.servers}'),
        ),
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, _) {
                        ...
                        var server = ref.watch(miniMaxApiServerAddressProvider);
