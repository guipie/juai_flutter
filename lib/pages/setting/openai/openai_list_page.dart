...
import '../gemini/gemini_add_page.dart';
import '../ollama/ollama_add_page.dart';
                                ...
                                children: [
                                  ...
                                  Builder(builder: (context) {
                                    return PullDownButton(
                                      ...
                                      itemBuilder: (context) {
                                        return item.getTextModels.where((element) => element.id != null && element.id!.isNotEmpty).map((e) {
                                          return PullDownMenuItem(
                                            title: e.id?.replaceFirst('models/', '') ?? '',
                                            icon: e.id == (item.defaultModelType?.id ?? item.supportedModels?.first.id) ? CupertinoIcons.checkmark : null,
                                      ...
                                      buttonBuilder: (context, showMenu) => Container(
                                        ...
                                        child: Text(
                                          (item.defaultModelType?.id ?? item.supportedModels?.first.id ?? '').replaceFirst('models/', ''),
                                          style: TextStyle(
                                            color: Theme.of(context).primaryColor,
                                            fontSize: 10,
                                          ),
