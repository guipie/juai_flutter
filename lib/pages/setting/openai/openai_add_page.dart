          ...
          child: Column(
            ...
            children: [
              ...
              SettingWithTitle(
                ...
                widget: CommonTextField(color: Theme.of(context).canvasColor, controller: orgController, hintText: S.current.input_text),
              ),
              const SizedBox(height: 15),
              SettingWithTitle(
                label: 'API Key',
                widget: CommonTextField(maxLine: 3, color: Theme.of(context).canvasColor, controller: controller, hintText: 'sk-xxxxxx'),
              ),
              const SizedBox(height: 15),
              Container(
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, _) {
                        ...
                        var server = ref.watch(apiServerAddressProvider);
              ...
              Container(
                ...
                try {
                  ...
                  if (supportedModels.where((element) => element.id?.contains('gpt-4') == true).isNotEmpty) {
                    openAi.defaultModelType = supportedModels.firstWhere((element) => element.id?.contains('gpt-4') == true);
                  }
