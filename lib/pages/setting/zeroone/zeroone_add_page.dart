...
class ZeroOneAddPage extends ConsumerStatefulWidget {
  ...
  const ZeroOneAddPage({super.key, this.openAi});

  @override
  ConsumerState createState() => _ZeroOneAddPageState();
}

class _ZeroOneAddPageState extends ConsumerState<ZeroOneAddPage> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.openAi?.time != null ? '${S.current.edit} ${APIType.zeroOne.name} ${S.current.servers}' : '${S.current.btn_add} ${APIType.zeroOne.name} ${S.current.servers}'),
        ),
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, _) {
                        ...
                        var server = ref.watch(zeroOneApiServerAddressProvider);
              ...
              Container(
                ...
                if (ref.watch(zeroOneApiServerAddressProvider).isEmpty) {
