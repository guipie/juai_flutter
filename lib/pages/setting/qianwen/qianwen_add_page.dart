...
class QianWenAddPage extends ConsumerStatefulWidget {
  final AllModelBean? openAi;

  const QianWenAddPage({super.key, this.openAi});

  @override
  ConsumerState createState() => _QianWenAddPageState();
}

class _QianWenAddPageState extends ConsumerState<QianWenAddPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ref.watch(qianwenApiServerAddressProvider.notifier).update((state) => openAi.apiServer ?? 'https://dashscope.aliyuncs.com');
    });
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: Text(widget.openAi?.time != null ? '${S.current.edit} 通义千问 ${S.current.servers}' : '${S.current.btn_add} 通义千问 ${S.current.servers}'),
        ),
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, _) {
                        ...
                        var server = ref.watch(qianwenApiServerAddressProvider);
              ...
              Container(
                ...
                if (ref.watch(qianwenApiServerAddressProvider).isEmpty) {
