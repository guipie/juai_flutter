...
class HiveBox {
  ...
  ///子key
  static const String cAppConfigAutoGenerateTitle =
      'autoGenerateTitle'; //自动生成标题
  static const String cAppConfigOpenICloud = 'openICloud'; //是否开启iCloud同步
  ...
  static const String cAppConfigGlobalLanguageCode =
      'globalLanguageCode'; //默认语言
  ...
  String get temperature =>
      _appConfig.get(cDefaultTemperature, defaultValue: "0.5") ?? "0.5";

  String get fromLanguage =>
      _appConfig.get(cAppConfigFromLanguage,
          defaultValue: getLocaleLanguages()['zh-Hans']!) ??
      getLocaleLanguages()['zh-Hans']!;

  String get primaryColor =>
      _appConfig.get(cAppConfigPrimaryColor,
          defaultValue: const Color(0xff03DE75).value.toRadixString(16)) ??
      const Color(0xff03DE75).value.toRadixString(16);

  String get toLanguage =>
      _appConfig.get(cAppConfigToLanguage,
          defaultValue: getLocaleLanguages()['en']!) ??
      getLocaleLanguages()['en']!;

  String get globalLanguageCode =>
      _appConfig.get(cAppConfigGlobalLanguageCode, defaultValue: 'auto') ??
      'en';
