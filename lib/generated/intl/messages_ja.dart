...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "alias_desc": MessageLookupByLibrary.simpleMessage(
      "同じプロバイダーを複数追加する場合にのみ使用されます。",
    ),
    "alias_empty": MessageLookupByLibrary.simpleMessage("エイリアスは空にすることはできません。"),
    "alias_input": MessageLookupByLibrary.simpleMessage("エイリアスを入力してください。"),
    "alias_maxlength": MessageLookupByLibrary.simpleMessage(
      "エイリアスの最大文字数は 10 文字です。",
    ),
    "alias_repeat": MessageLookupByLibrary.simpleMessage("エイリアスを繰り返すことはできません。"),
    "alias_required": MessageLookupByLibrary.simpleMessage("エイリアス（必須）"),
    "apikey_repeat": MessageLookupByLibrary.simpleMessage(
      "ApiKey を繰り返すことはできません。",
    ),
    ...
    "canTalk": MessageLookupByLibrary.simpleMessage("会話可能"),
    "canVoice": MessageLookupByLibrary.simpleMessage("音声可能"),
    ...
    "download_success": MessageLookupByLibrary.simpleMessage("ダウンロードに成功しました。"),
    ...
    "hint_addServerDesc": MessageLookupByLibrary.simpleMessage(
      "サーバーアドレスを入力してください。",
    ),
    "hold_micro_phone_talk": MessageLookupByLibrary.simpleMessage(
      "下部のマイクを長押しして、チャットを開始してください。",
    ),
    "hold_talk": MessageLookupByLibrary.simpleMessage("長押しして話す"),
    "home_chat": MessageLookupByLibrary.simpleMessage("チャット"),
    "home_factory": MessageLookupByLibrary.simpleMessage("工房"),
    "home_server": MessageLookupByLibrary.simpleMessage("サービス"),
    "home_setting": MessageLookupByLibrary.simpleMessage("設定"),
    "input_name": MessageLookupByLibrary.simpleMessage("名前を入力してください。"),
    "input_text": MessageLookupByLibrary.simpleMessage("コンテンツを入力してください。"),
    "is_getting_modules": MessageLookupByLibrary.simpleMessage(
      "モデルを取得しています...",
    ),
    "is_responsing": MessageLookupByLibrary.simpleMessage("サーバーが応答しています..."),
    ...
    "new_version": MessageLookupByLibrary.simpleMessage("新しいバージョンが見つかりました。"),
    "no_audio_file": MessageLookupByLibrary.simpleMessage("音声ファイルを取得できません。"),
    "no_module_use": MessageLookupByLibrary.simpleMessage("使用可能なモデルがありません。"),
    ...
    "openai_setting": MessageLookupByLibrary.simpleMessage("ChatGPT プロバイダー"),
    ...
    "validate_success": MessageLookupByLibrary.simpleMessage("検証に成功しました。"),
    "version": MessageLookupByLibrary.simpleMessage("バージョン"),
    "vivid": MessageLookupByLibrary.simpleMessage("超現実的"),
    "voiceChat": MessageLookupByLibrary.simpleMessage("音声チャット"),
    "yes_know": MessageLookupByLibrary.simpleMessage("わかりました。"),
