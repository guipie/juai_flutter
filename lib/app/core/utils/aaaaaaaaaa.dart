...
import 'package:juai_flutter/app/core/utils/common_utils.dart';
...
void main() {
  ...
  LogUtil.e("Today DayOfYear: ${DateUtil.getDayOfYear(now)}");
  ...
  City? hisCity = JsonUtil.getObj(objStr, (v) => City.fromJson(v as Map<String, dynamic>));
  String listStr = "[{\"name\":\"成都市\"}, {\"name\":\"北京市\"}]";
  List<City>? cityList = JsonUtil.getObjList(listStr, (v) => City.fromJson(v as Map<String, dynamic>));
  LogUtil.e('JsonUtil -> hisCity: ${hisCity.toString()} ; cityList: ${cityList.toString()}');
  ...
  String yuan = '1.66';
  LogUtil.e("${MoneyUtil.changeFStr2YWithUnit("1160", format: MoneyFormat.NORMAL, unit: MoneyUnit.YUAN_ZH)}   ${MoneyUtil.changeYWithUnit(yuan, MoneyUnit.YUAN_ZH)}");
  ...
  LogUtil.e("add    a/b : ${a / b}    add: ${NumUtil.divide(a, b)}"); // a+b : 0.30000000000000004    add: 0.3
  LogUtil.e("mul    c*d : ${c * d}    mul: ${NumUtil.multiply(c, d)}    greaterThan: ${NumUtil.greaterThan(a, b)}"); //c*d : 705.9000000000001    mul: 705.9    greaterThan: false
  LogUtil.e("---------------- NumUtil en ----------------\n");

  LogUtil.e("---------------- ObjectUtil st ----------------");
  List<String> listA = ["A", "B", "C"];
  List<String> listB = ["A", "B", "C"];
  LogUtil.e("Two List Is Equal: ${ObjectUtil.twoListIsEqual(listA, listB)}");
  ...
  LogUtil.e("Timeline: ${TimelineUtil.formatByDateTime(
    dateTime1,
  ...
  LogUtil.e("Timeline formatA: ${TimelineUtil.formatA(
...
//    timerCountDown.setTotalTime(3 * 1000);
  timerCountDown.setOnTimerTickCallback((int value) {
    ...
    LogUtil.e("CountDown: ${tick.toInt()}");
  });
